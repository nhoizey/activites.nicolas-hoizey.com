...
Ce site est statique, généré avec [{{ eleventy.generator }}](https://www.11ty.dev/). De multiples automatismes sont apportés par le plugin [Pack11ty](https://pack11ty.dev/).
