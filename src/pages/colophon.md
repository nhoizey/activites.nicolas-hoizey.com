...
Ce site est statique, généré avec [{{ eleventy.generator }}](https://www.11ty.dev/). Les contenus sont rédigés en Markdown et les gabarits de pages sont écrits en Nunjucks.
...
Toutes les photos sont prises par moi-même, et sont redimensionnées et optimisées avec [Cloudinary](https://cloudinary.com/), grâce à des URLs générées par le plugin [Eleventy Image](https://www.11ty.dev/docs/plugins/image/).
